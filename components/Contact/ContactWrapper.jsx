...
import loginImage from "@/public/images/registeration/contactimg.jpg"
...
import greenMobIcon from "@/public/images/registeration/greenMobIcon.svg"
import greenMailIcon from "@/public/images/registeration/greenMainIcon.svg"
import greenLocationIcon from "@/public/images/registeration/greenLocationIcon.svg"
...
const makeContactSchema = (lang) =>
    z.object({
        ...
        name: z
            ...
            .min(3, { message: t(lang, "name_min_length") }),
        message: z
            .string()
...
export default function ContactWrapper() {
    ...
    const onSubmit = (data) => {
        ...
        setTimeout(() => {
            setLoading(false)
            alert(t(lang, "message_sent_successfully") || "Message sent successfully!");
        }, 2000)
    }
