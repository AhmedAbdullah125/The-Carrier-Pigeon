...
import profileIcon from "@/public/images/license/profileIcon.svg"
import Image from "next/image"
import { cn } from "@/lib/utils"
import locationIcon from "@/public/images/license/locationIcon.svg"
import usersIcon from "@/public/images/license/usersIcon.svg"
import phoneIcon from "@/public/images/license/phoneIcon.svg"
import calenderIcon from "@/public/images/license/calender.svg"
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="form-field">
                                            ...
                                            <FormControl>
                                                ...
                                                >
                                                    <SelectTrigger className={`field-input select-trigger ${lang == "ar" ? "ar-select-trigger" : "en-select-trigger"} ${form.formState.errors.nationality ? 'error-input' : field.value ? 'success-input' : ''}`}>
                                        ...
                                        <FormItem className="form-field">
                                            ...
                                            <FormControl>
                                                <Select
                                                    ...
                                                    onValueChange={field.onChange}
                                                >
                                                    <SelectTrigger className={`field-input select-trigger ${lang == "ar" ? "ar-select-trigger" : "en-select-trigger"} ${form.formState.errors.licenseType ? 'error-input' : field.value ? 'success-input' : ''}`}>
